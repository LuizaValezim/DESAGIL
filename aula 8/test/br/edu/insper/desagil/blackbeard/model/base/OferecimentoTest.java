...
class OferecimentoTest {
	...
	public void testSetters() {
		...
		Map<Date, String> plano = new HashMap<>();
		plano.put(new Date(0), "apresentaÃ§Ã£o");
		List<Matricula> matriculas = new ArrayList<>();
		matriculas.add(new Matricula(new Aluno(1, "JoÃ£o"), true));

		oferecimento.setDisciplina(new Disciplina("DESAGIL", "Desenvolvimento Colaborativo Ã�gil", ementa));
		...
		Map<Date, String> expectedPlano = new HashMap<>();
		expectedPlano.put(new Date(0), "apresentaÃ§Ã£o");
		List<Matricula> expectedMatriculas = new ArrayList<>();
		expectedMatriculas.add(new Matricula(new Aluno(1, "JoÃ£o"), true));

		assertEquals("DESAGIL", oferecimento.getDisciplina().getCodigo());
		assertEquals("Desenvolvimento Colaborativo Ã�gil", oferecimento.getDisciplina().getNome());
		assertEquals(expectedEmenta, oferecimento.getDisciplina().getEmenta());
